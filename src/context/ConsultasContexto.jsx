...
const MODELOS = [
  ...
  { diaSemana: 4, inicio: '09:30', fim: '10:00', paciente: 'Lucia Gomes', dentista: 'Dr. Ricardo Alves', especialidade: 'Endodontia', status: 'Confirmado' },
  { diaSemana: 4, inicio: '10:30', fim: '11:00', paciente: 'Maria Silva', dentista: 'Dra. Fernanda Costa', especialidade: 'Limpeza', status: 'Cancelado' },
  { diaSemana: 4, inicio: '11:15', fim: '11:45', paciente: 'Amanda Pires', dentista: 'Dra. Fernanda Costa', especialidade: 'Limpeza', status: 'Cancelado', observacoes: 'Reagendar para próxima quinzena.' },
...
const criarConsultasIniciais = () => {
  ...
  return MODELOS.map((modelo, indice) => {
    const paciente = PACIENTES.find((item) => item.nome === modelo.paciente);
    return {
      id: `c${indice + 1}`,
